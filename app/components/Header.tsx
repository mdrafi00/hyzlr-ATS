...
function Header() {
  ...
  <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
    ...
    <div className="md:ml-auto flex flex-wrap items-center text-base justify-center inline-flex items-center">
        <span className='text-white mx-6 italic'>Smart AI Assistant</span>
